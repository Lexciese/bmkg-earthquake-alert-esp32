...
const char* ssid = "Bulek";
const char* password = "Sw4ntoro";
...
// API URLs
String apiUrl_bmkg = "https://bmkg-content-inatews.storage.googleapis.com/lastQL.json?";
String apiKey = "324e4a7f4f8bc4b1fca8fd5da3ba81f4";
String location = "Prambanan";
